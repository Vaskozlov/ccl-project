#ifndef CCL_PROJECT_STRING_SPLITTER_HPP
#define CCL_PROJECT_STRING_SPLITTER_HPP
...
namespace ccl::fmt::core
{
    ...
    public:
        ...
        CCL_DECL auto get() const noexcept -> const storage_t &
        {
            return blocks;
        }
    ...
    private:
        CCL_DECL auto isEveryBlockFilled() const noexcept -> bool
        {
    ...
    template<ConstString String>
    CCL_DECL auto splitString() -> typename StringSplitter<String>::storage_t
    {
...
#endif /* CCL_PROJECT_STRING_SPLITTER_HPP */
