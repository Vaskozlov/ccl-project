#ifndef AST_LANG_2_DEFINITION_ARGUMENT_HPP
#define AST_LANG_2_DEFINITION_ARGUMENT_HPP

#include <ast-lang-2/ast/core/node.hpp>

namespace astlang2::ast::function::def
{
    class ArgumentDefinition final : public core::AstlangNode
    {
    public:
...
#endif /* AST_LANG_2_DEFINITION_ARGUMENT_HPP */
