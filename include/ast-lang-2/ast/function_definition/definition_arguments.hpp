#ifndef AST_LANG_2_DEFINITION_ARGUMENTS_HPP
#define AST_LANG_2_DEFINITION_ARGUMENTS_HPP

#include <ast-lang-2/ast/core/node.hpp>

namespace astlang2::ast::function::def
{
    class ArgumentsDefinition final : public core::AstlangNode
    {
    public:
...
#endif /* AST_LANG_2_DEFINITION_ARGUMENTS_HPP */
