...
namespace ccl::lexer::rule
{
    RuleReference::RuleReference(
        LexicalAnalyzer &lexical_analyzer, const isl::string_view sequence_starter,
        const isl::string_view sequence_ender, RuleBlockInterface::TextIterator &rule_iterator)
      : Sequence{SequenceFlags{.multiline = false, .noEscaping = false,}, sequence_starter, sequence_ender, rule_iterator,}
      , lexicalAnalyzer{lexical_analyzer}
    {}

    RuleReference::RuleReference(
        LexicalAnalyzer &lexical_analyzer, const isl::string_view sequence_begin_and_end,
