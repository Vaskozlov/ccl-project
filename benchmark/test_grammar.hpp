#ifndef CCL_PROJECT_BENCHMARK_TEST_GRAMMAR_HPP
#define CCL_PROJECT_BENCHMARK_TEST_GRAMMAR_HPP

#include <isl/string_view.hpp>

namespace ccl::benchmark
{
    constexpr inline isl::string_view AstLangGrammar = R"(
%PARSER%
...
#endif /* CCL_PROJECT_BENCHMARK_TEST_GRAMMAR_HPP */
