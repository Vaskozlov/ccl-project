...
template<>
CCL_DECL auto ccl::lexer::lexerEnumToString<tparser::TestParserToken>(tparser::TestParserToken value) -> isl::string_view;
...
namespace tparser
{
    ...
    inline constexpr isl::StaticFlatmap<TestParserToken, isl::string_view, 8> ToStringTestParserToken
    {    
...
namespace ccl::lexer {
    template<>
    CCL_DECL auto lexerEnumToString<tparser::TestParserToken>(tparser::TestParserToken value) -> isl::string_view {
